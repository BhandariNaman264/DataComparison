...
namespace CPToolServerSide.Controllers
{
    ...
    [ApiController]
    public class AnalyzeSCRController : ControllerBase
    {
        private readonly CPTDBContext _context;

        public AnalyzeSCRController(CPTDBContext context)
        {
            _context = context;
        }
        ...
        // GET: api/AnalyzeSCR
        [HttpGet]
        public async Task<ActionResult<IEnumerable<AnalyzeSCR>>> GetAnalyzeSCR()
        {
            return await _context.AnalyzeSCR.ToListAsync();
        }

        // GET: api/AnalyzeSCR/5
        [HttpGet("{id}")]
        public async Task<ActionResult<IEnumerable<AnalyzeSCR>>> GetAnalyzeSCR(int id)
        {
            ...
            List<AnalyzeSCR> discrepacies = new List<AnalyzeSCR>();
            ...
            if (status == 0 && compared == 2)
            {
                ...
                if (directoryInfoOutput.Exists)
                {
                    ...
                    if (version1_path != "" && version2_path != "" && results == "SUCCESS")
                    {
                        ...
                        // Create AnalyzeSCR Message - No Difference

                        AnalyzeSCR no_difference = new AnalyzeSCR
                        {
                            Comparison_ID = id,
                            Client = input.Client,
                        ...
                        _context.AnalyzeSCR.Add(no_difference);
                        await _context.SaveChangesAsync();
                    ...
                    else if (version1_path == "" && version2_path == "" && results == "SUCCESS")
                    {
                        ...
                        // Create AnalyzeSCR Message - No Difference Reason

                        AnalyzeSCR no_difference_reason = new AnalyzeSCR
                        {
                            Comparison_ID = id,
                            Client = input.Client,
                        ...
                        _context.AnalyzeSCR.Add(no_difference_reason);
                        await _context.SaveChangesAsync();
                    ...
                    else if (version1_path == "" && version2_path == "" && results == "WARNING")
                    {
                        ...
                        // Create AnalyzeSCR Message - Difference Reason

                        AnalyzeSCR difference_reason = new AnalyzeSCR
                        {
                            Comparison_ID = id,
                            Client = input.Client,
                        ...
                        _context.AnalyzeSCR.Add(difference_reason);
                        await _context.SaveChangesAsync();
                    ...
                    else if (version1_path != "" && version2_path != "" && results == "WARNING")
                    {
                        ...
                        if(analyze_check.Length == 0)
                        {
                            ...
                            // Create AnalyzeSCR Message - Can't Analyze

                            AnalyzeSCR cant_analyze = new AnalyzeSCR
                            {
                                Comparison_ID = id,
                                Client = input.Client,
                            ...
                            _context.AnalyzeSCR.Add(cant_analyze);
                            await _context.SaveChangesAsync();
                        ...
                        {
                            if (line.Split("|")[0].Trim() == "Employee Schedule Pay Summary Header")
                            {
                            ...
                            else
                            {
                                ...
                                else if (line.Split("|")[0].Trim() != "" && line.Split("|")[1].Trim() != "" && line.Split("|")[0].Trim() != line.Split("|")[1].Trim())
                                {
                                    ...
                                    if ((version1_records[8] != "") && (version2_records[8] != "") && (version1_records[7] != "") && (version2_records[7] != "") && (version1_records[0] == version2_records[0]) && (version1_records[1] == version2_records[1]) && (version1_records[2] == version2_records[2]) && (version1_records[3] == version2_records[3]) && (version1_records[4] == version2_records[4]) && (version1_records[5] == version2_records[5]) && (version1_records[6] == version2_records[6]) && (version1_records[8] != version2_records[8]) && (version1_records[9] == version2_records[9]) && (version1_records[10] == version2_records[10]) && (version1_records[11] == version2_records[11]) && (version1_records[12] == version2_records[12]) && (version1_records[13] == version2_records[13]))
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            if (DateTime.Compare(anchortime1_v1, null_date) != 0 && DateTime.Compare(anchortime2_v1, null_date) != 0 && anchortime1_v1 != null && anchortime2_v1 != null && DateTime.Compare(anchortime1_v1, anchortime2_v1) == 0)
                                            {
                                                ...
                                                AnalyzeSCR duplicate_tardy = new AnalyzeSCR
                                                {
                                                    Comparison_ID = id,
                                                    Line = line_index,
                                                    Client = input.Client,
                                                ...
                                                _context.AnalyzeSCR.Add(duplicate_tardy);
                                                await _context.SaveChangesAsync();
                                        ...
                                        if (version1_records[7] == version2_records[7])
                                        {
                                            ...
                                            AnalyzeSCR different_id = new AnalyzeSCR
                                            {
                                                Comparison_ID = id,
                                                Line = line_index,
                                                Client = input.Client,
                                            ...
                                            _context.AnalyzeSCR.Add(different_id);
                                            await _context.SaveChangesAsync();
                                    ...
                                    else if ((version1_records[8] != "") && (version2_records[8] != "") && (version1_records[0] == version2_records[0]) && (version1_records[1] == version2_records[1]) && (version1_records[2] == version2_records[2]) && (version1_records[3] == version2_records[3]) && (version1_records[4] == version2_records[4]) && (version1_records[5] == version2_records[5]) && (version1_records[6] == version2_records[6]) && (version1_records[7] == version2_records[7]) && (version1_records[9] == version2_records[9]) && (version1_records[10] == version2_records[10]) && (version1_records[11] != version2_records[11]))
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            if (DateTime.Compare(endtime_endtime, null_date) != 0 && endtime_endtime != null && DateTime.Compare(endtime_endtime, time_end) != 0 && DateTime.Compare(starttime_starttime, null_date) != 0 && starttime_starttime != null && DateTime.Compare(starttime_starttime, time_start) != 0)
                                            {
                                                ...
                                                AnalyzeSCR overlapping_tardy = new AnalyzeSCR
                                                {
                                                    Comparison_ID = id,
                                                    Line = line_index,
                                                    Client = input.Client,
                                                ...
                                                _context.AnalyzeSCR.Add(overlapping_tardy);
                                                await _context.SaveChangesAsync();
                                            ...
                                            else
                                            {
                                                ...
                                                AnalyzeSCR different_pay = new AnalyzeSCR
                                                {
                                                    Comparison_ID = id,
                                                    Line = line_index,
                                                    Client = input.Client,
                                                ...
                                                _context.AnalyzeSCR.Add(different_pay);
                                                await _context.SaveChangesAsync();
                                    ...
                                    else if ((version1_records[10] != "") && (version2_records[10] != "") && (version1_records[13] != "") && (version2_records[13] != "") && (version1_records[0] == version2_records[0]) && (version1_records[1] == version2_records[1]) && (version1_records[2] == version2_records[2]) && (version1_records[3] == version2_records[3]) && (version1_records[4] == version2_records[4]) && (version1_records[5] == version2_records[5]) && (version1_records[6] == version2_records[6]) && (version1_records[7] == version2_records[7]) && (version1_records[8] == version2_records[8]) && (version1_records[9] == version2_records[9]) && (version1_records[10] != version2_records[10]) && (version1_records[11] == version2_records[11] && (version1_records[12] == version2_records[12]) && (version1_records[13] != version2_records[13])))
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            if (effective_from1_v1 != null && effective_from2_v1 != null && DateTime.Compare(effective_from1_v1, null_date) != 0 && DateTime.Compare(effective_from2_v1, null_date) != 0)
                                            {
                                                ...
                                                if (in_period1_v1 && in_period2_v1)
                                                {
                                                    ...
                                                    AnalyzeSCR duplicate_wa = new AnalyzeSCR
                                                    {
                                                        Comparison_ID = id,
                                                        Line = line_index,
                                                        Client = input.Client,
                                                    ...
                                                    _context.AnalyzeSCR.Add(duplicate_wa);
                                                    await _context.SaveChangesAsync();
                                        ...
                                        AnalyzeSCR mannual_rate = new AnalyzeSCR
                                        {
                                            Comparison_ID = id,
                                            Line = line_index,
                                            Client = input.Client,
                                        ...
                                        _context.AnalyzeSCR.Add(mannual_rate);
                                        await _context.SaveChangesAsync();
                                    ...
                                    AnalyzeSCR mannual = new AnalyzeSCR
                                    {
                                        Comparison_ID = id,
                                        Line = line_index,
                                        Client = input.Client,
                                    ...
                                    _context.AnalyzeSCR.Add(mannual);
                                    await _context.SaveChangesAsync();
                                ...
                                else if (line.Split("|")[0].Trim() != "" && line.Split("|")[1].Trim() == "")
                                {
                                    ...
                                    List<AnalyzeSCR>  overlapping_tardy = await _context.AnalyzeSCR.Where(e => e.Employee_Pay_AdjustID.Contains(version1_records[8]) && e.Employee_ID == employee_ID && e.Comparison_ID == id && e.Buisness_Date == buisness_date && e.Discrepancy == "Overlapping Tardy").ToListAsync();
                                    ...
                                    List<AnalyzeSCR>  broken_pay = await _context.AnalyzeSCR.Where(e => e.Employee_ID == employee_ID && e.Comparison_ID == id && e.Buisness_Date == buisness_date && e.Discrepancy == "Total Minutes and Pay Amount is different - Mannual Investigation Needed").ToListAsync();
                                    ...
                                    if (broken_pay.Count == 1)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                if (broken_line.Split("|")[0].Trim() == "Employee Schedule Pay Summary Header")
                                                {
                                                    // This is the first line of Analyze File, skip this iteration and continue with next line which have records from both version.
                                                    continue;
                                                }
                                    ...
                                    if (discrepancy != "Version 2 has no corresponding record - Reason - Pay Amount is broken down to more than one records" && discrepancy != "Version 2 has no corresponding record - Reason - Overlapping Tardy")
                                    {
                                        ...
                                        {
                                            if (position.Split("|")[0].Trim() == "Employee Schedule Pay Summary Header")
                                            {
                                                // This is the first line of Analyze File, skip this iteration and continue with next line which have records from both version.
                                                continue;
                                            }
                                    ...
                                    AnalyzeSCR no_adjacent = new AnalyzeSCR
                                    {
                                        Comparison_ID = id,
                                        Line = line_index,
                                        Client = input.Client,
                                    ...
                                    _context.AnalyzeSCR.Add(no_adjacent);
                                    await _context.SaveChangesAsync();
                                ...
                                else if (line.Split("|")[0].Trim() == "" && line.Split("|")[1].Trim() != "")
                                {
                                    ...
                                    // Check if Overlapping Tardy is causing this difference
                                    List<AnalyzeSCR>  overlapping_tardy = await _context.AnalyzeSCR.Where(e => e.Employee_Pay_AdjustID.Contains(version2_records[8]) && e.Employee_ID == employee_ID && e.Comparison_ID == id && e.Buisness_Date == buisness_date && e.Discrepancy == "Overlapping Tardy").ToListAsync();
                                    ...
                                    // Check if Duplicate Tardy is caused by this difference, such that we have another similar record in other version which have no corresponding record and these two records are Duplicate Tardy
                                    List<AnalyzeSCR>  duplicate_tardy_align = await _context.AnalyzeSCR.Where(e => e.Employee_Pay_AdjustID.Contains(version2_records[8]) && e.Employee_ID == employee_ID && e.Comparison_ID == id && e.Buisness_Date == buisness_date && e.Discrepancy == "Version 1 and 2 has no corresponding aligned record, but these records are similar and exist as Duplicate Tardy").ToListAsync();
                        ...
                        // Create new AnalyzeSCR File with Indexing
                        ...
                        using (StreamWriter writer = new StreamWriter(analyze_view, true))
                        {
                            ...
                            foreach (string line in System.IO.File.ReadLines(analyze_file))
                            {
                                ...
                                else if (line.Split("|")[0].Trim() == "Employee Schedule Pay Summary Header")
                                {
                    ...
                    else if (version1_path == "" && version2_path != "" && results == "WARNING")
                    {
                        ...
                        // Create AnalyzeSCR Message - Cant' Analyze
            ...
            else
            {
                ...
                List<AnalyzeSCR> already_discrepacies = await _context.AnalyzeSCR.Where(e => e.Comparison_ID == id).ToListAsync();
        ...
        // PUT: api/AnalyzeSCR/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPut("{id}")]
        public async Task<IActionResult> PutAnalyzeSCR(int id, AnalyzeSCR analyzeSCR)
        {
            if (id != analyzeSCR.ID)
            {
                return BadRequest();
            ...
            _context.Entry(analyzeSCR).State = EntityState.Modified;
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<AnalyzeSCR>> PostAnalyzeSCR(AnalyzeSCR analyzeSCR)
        {
            _context.AnalyzeSCR.Add(analyzeSCR);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetAnalyzeSCR", new { id = analyzeSCR.ID }, analyzeSCR);
        }

        // DELETE: api/AnalyzeSCR/5
        [HttpDelete("{id}")]
        public async Task<ActionResult<AnalyzeSCR>> DeleteAnalyzeSCR(int id)
        {
            var analyzeSCR = await _context.AnalyzeSCR.FindAsync(id);
            if (analyzeSCR == null)
            {
                return NotFound();
            }

            _context.AnalyzeSCR.Remove(analyzeSCR);
            await _context.SaveChangesAsync();

            return analyzeSCR;
        }

        private bool AnalyzeSCRExists(int id)
        {
            return _context.AnalyzeSCR.Any(e => e.ID == id);
        }
